...
FVector AAuroCharacterBase::GetCombatSocketLocation_Implementation(const FGameplayTag& MontageTag)
{
...
TArray<FTaggedMontage> AAuroCharacterBase::GetAttackMontages_Implementation()
{
